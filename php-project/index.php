...
$sliderSelectQuery = "SELECT * FROM sliders WHERE status=1 ORDER BY ordering ASC";
$sliderRec = $conn->query($sliderSelectQuery);

$blockSelectQuery = "SELECT * FROM blocks WHERE status=1";
$blockRec = $conn->query($blockSelectQuery);

// $_block_rec = mysqli_fetch_assoc($blockRec);

// $a = $_block_rec['description'];

// echo strip_tags($a);


// while($_block_rec = mysqli_fetch_assoc($blockRec)) {

//     echo $_block_rec['description'];
// }
...
// $_img_data = mysqli_fetch_assoc($sliderRec);

// while($_img_data = mysqli_fetch_assoc($sliderRec)) {
//     echo "<pre>";
//     print_r($_img_data["image"]);
// }
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                <div class="owl-carousel header-carousel">
                    ...
                    // $i=1;
                        while ($_img_data = mysqli_fetch_assoc($sliderRec)) { 
                    ?>
                        <!-- For active class: <div class="owl-carousel-item <//?= ($i) ? 'active':''; $i=0; ?>"> -->
                        <div class="owl-carousel-item position-relative">
                            <img class="img-fluid" src="admin/<?= $_img_data['image'] ?>" alt="">
                        </div>
                    <?php } ?>
                </div>
            ...
            <?php while($_block_rec = mysqli_fetch_assoc($blockRec)) { ?>
                ...
                <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="admin/<?= $_block_rec['banner_image'] ?>" alt="">
                        </div>
                ...
                <a class="btn" href="block.php?id=<?= $_block_rec['id'] ?>"><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                </div>
                </div>
                <?php } ?>
            </div>
