  ...
  if($conQuery->num_rows){
    $_datas = mysqli_fetch_assoc($conQuery);
    //dd($_datas);

    $date1 = strtotime($_datas['created_at']); 
  ...
  <nav class="navbar-default navbar-side" role="navigation">
      <div class="sidebar-collapse">
          <ul class="nav" id="main-menu">
              <li>
                  <div class="user-img-div">
                      ...
                      <div class="inner-text">
                          ...
                          <br>
                          <small>Last Login: <?= $loginBefore?></small>
                      </div>
                  </div>
              ...
              <li>
                  <a href="manage-block.php"><i class="fa fa-desktop"></i>Manage Block <span class="fa arrow"></span></a>
                  <ul class="nav nav-second-level">
                      <li>
              ...
              <li>
                  <a href="manage-enquiry.php"><i class="fa fa-desktop"></i>Manage Enquiry</a>
              </li>
